...
import drone_logo from './logo.jpg';
          ...
          <div className="form">
            ...
            <form action="#" onSubmit={validateForm}>
              ...
              <FontAwesomeIcon className='icon' icon={faUser} />
                <input id='input1' type="text" placeholder='Operator Login Address' onKeyUp={handleMail}/>
              </div>
              <div className="eInput">
              <FontAwesomeIcon className='icon' icon={faLock} />
                <input id='input2' type="password" placeholder='Operator Password' onKeyUp={handlePassword}/>
              </div>
